...
# Paths to JSON files
BASE_DIR = r"c:/UCB_CS182_project/"
RESULT_DIR = os.path.join(BASE_DIR, "results/bf16")
...
FORGETTING_JSON = os.path.join(RESULT_DIR, "forgetting_history_MATH_to_HotpotQA_fp32.json")
...
def plot_joint(data):
    ...
    plt.plot(steps, hotpot, 'o-', label="HotpotQA Val Loss", color="blue")
    plt.plot(steps, math, 'o-', label="MATH Val Loss", color="red")
    plt.title("Mixture Training: MATH + HotpotQA")
