...
This is the interleaving experiment for our Language Model Catastrophic Forgetting.

The approaches to run this baseline:

## Approach 1 (Better)

1. Upload the `interleave.ipynb` to colab.
...
2. Modify the directories in `interleave.py` to the directories of your downloaded assets
3. Run `interleave.py`
